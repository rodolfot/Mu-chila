...
| `Data\Monster\MonsterSetBase\*.xml` (43 mapas) | Spawns de SPOT/MONSTER refeitos a partir do kit: 2.602 grupos de 3 espalhados por igual (k-means) e 84 pontos de farm de 12 monstros, mesmo total de monstros (`tools\Distribuir-Spawns.py`). Raklion: área de cada monstro +10 tiles e +40 monstros (120 → 160); Nars: monstros no mapa todo e +60 (115 → 175) | 26/09/2026: o agrupamento de 23/09 (grupos de 5 no "ponto mais distante") deixava o meio dos mapas vazio; pedido: respawn equilibrado e pontos de farm |
