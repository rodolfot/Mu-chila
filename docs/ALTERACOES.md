...
| `Data\EventItemBagManager.txt` + `Data\EventItemBag\236 - Season Level Reward A.txt`, `237 - Season Level Reward B.txt` (novos) | Season Level Reward A (7582) dá Bless, Soul ou Chaos; B (7608) dá Bless, Soul, Life, Creation ou Chaos (1 joia aleatória ao largar a caixa no chão) | As caixas diziam "drope para receber um presente", mas não tinham conteúdo no kit; a B cai de monstros |
